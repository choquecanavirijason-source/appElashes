...
abstract class _PermissionDto implements PermissionDto {
  const factory _PermissionDto(
      ...
      required final String name}) = _$PermissionDtoImpl;
...
abstract class _RoleDto implements RoleDto {
  const factory _RoleDto(
      ...
      final List<PermissionDto> permissions}) = _$RoleDtoImpl;
...
abstract class $BranchSummaryDtoCopyWith<$Res> {
  factory $BranchSummaryDtoCopyWith(
          BranchSummaryDto value, $Res Function(BranchSummaryDto) then) =
      _$BranchSummaryDtoCopyWithImpl<$Res, BranchSummaryDto>;
  @useResult
  $Res call(
      {int id, String name, String? address, String? city, String? department});
}
...
abstract class _$$BranchSummaryDtoImplCopyWith<$Res>
    implements $BranchSummaryDtoCopyWith<$Res> {
  factory _$$BranchSummaryDtoImplCopyWith(_$BranchSummaryDtoImpl value,
...
class __$$BranchSummaryDtoImplCopyWithImpl<$Res>
  ...
  __$$BranchSummaryDtoImplCopyWithImpl(_$BranchSummaryDtoImpl _value,
  ...
  $Res call({
    ...
    return _then(_$BranchSummaryDtoImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$BranchSummaryDtoImpl implements _BranchSummaryDto {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$BranchSummaryDtoImplToJson(
      this,
    );
  }
}
...
abstract class _BranchSummaryDto implements BranchSummaryDto {
  const factory _BranchSummaryDto(
      ...
      final String? address,
      final String? city,
      final String? department}) = _$BranchSummaryDtoImpl;
...
class _$UserResponseDtoImpl implements _UserResponseDto {
  ...
  @override
  String toString() {
    return 'UserResponseDto(id: $id, username: $username, email: $email, phone: $phone, isActive: $isActive, createdAt: $createdAt, roleId: $roleId, branchId: $branchId, role: $role, branch: $branch, skillLevel: $skillLevel, directPermissions: $directPermissions)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._directPermissions, _directPermissions));
  }
...
abstract class _UserResponseDto implements UserResponseDto {
  const factory _UserResponseDto(
      ...
      @JsonKey(name: 'direct_permissions')
      final List<PermissionDto> directPermissions}) = _$UserResponseDtoImpl;
...
class _$LoginResponseDtoImpl implements _LoginResponseDto {
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, accessToken, tokenType, user, expiresAt, expiresInMinutes);
...
abstract class _LoginResponseDto implements LoginResponseDto {
  const factory _LoginResponseDto(
      ...
      @JsonKey(name: 'expires_in_minutes')
      required final int expiresInMinutes}) = _$LoginResponseDtoImpl;
