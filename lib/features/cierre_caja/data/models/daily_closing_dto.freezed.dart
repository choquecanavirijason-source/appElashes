...
abstract class $DailyClosingItemDtoCopyWith<$Res> {
  factory $DailyClosingItemDtoCopyWith(
          DailyClosingItemDto value, $Res Function(DailyClosingItemDto) then) =
...
abstract class _$$DailyClosingItemDtoImplCopyWith<$Res>
    implements $DailyClosingItemDtoCopyWith<$Res> {
  factory _$$DailyClosingItemDtoImplCopyWith(_$DailyClosingItemDtoImpl value,
...
class __$$DailyClosingItemDtoImplCopyWithImpl<$Res>
  ...
  __$$DailyClosingItemDtoImplCopyWithImpl(_$DailyClosingItemDtoImpl _value,
  ...
  $Res call({
    ...
    return _then(_$DailyClosingItemDtoImpl(
      appointmentId: null == appointmentId
          ? _value.appointmentId
          : appointmentId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$DailyClosingItemDtoImpl implements _DailyClosingItemDto {
  ...
  @override
  String toString() {
    return 'DailyClosingItemDto(appointmentId: $appointmentId, ticketCode: $ticketCode, saleCode: $saleCode, clientName: $clientName, serviceNames: $serviceNames, professionalName: $professionalName, professionalId: $professionalId, startTime: $startTime, durationMinutes: $durationMinutes, status: $status, totalPrice: $totalPrice, commissionRate: $commissionRate, commission: $commission, branchName: $branchName, saleId: $saleId, paymentMethod: $paymentMethod, isPaid: $isPaid, advancePaymentAmount: $advancePaymentAmount, balanceDue: $balanceDue)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DailyClosingItemDtoImplToJson(
      this,
    );
  }
}
...
abstract class $ProfessionalSummaryDtoCopyWith<$Res> {
  factory $ProfessionalSummaryDtoCopyWith(ProfessionalSummaryDto value,
...
/// @nodoc
class _$ProfessionalSummaryDtoCopyWithImpl<$Res,
...
class __$$ProfessionalSummaryDtoImplCopyWithImpl<$Res>
    extends _$ProfessionalSummaryDtoCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$ProfessionalSummaryDtoImpl(
      professionalId: freezed == professionalId
          ? _value.professionalId
          : professionalId // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$ProfessionalSummaryDtoImpl implements _ProfessionalSummaryDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, professionalId, professionalName,
      ticketCount, totalPrice, commission, commissionRate);
  ...
  _$$ProfessionalSummaryDtoImplCopyWith<_$ProfessionalSummaryDtoImpl>
      get copyWith => __$$ProfessionalSummaryDtoImplCopyWithImpl<
          _$ProfessionalSummaryDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ProfessionalSummaryDtoImplToJson(
      this,
    );
  }
}
...
mixin _$DailyClosingResponseDto {
  ...
  double get totalUnpaid => throw _privateConstructorUsedError;
  @JsonKey(
      name: 'totals_by_payment',
      fromJson: _parseDoubleMap,
      toJson: _identityMap)
  Map<String, double> get totalsByPayment => throw _privateConstructorUsedError;
...
abstract class $DailyClosingResponseDtoCopyWith<$Res> {
  factory $DailyClosingResponseDtoCopyWith(DailyClosingResponseDto value,
  ...
  $Res call(
      ...
      @JsonKey(name: 'total_unpaid') double totalUnpaid,
      @JsonKey(
          name: 'totals_by_payment',
          fromJson: _parseDoubleMap,
          toJson: _identityMap)
...
/// @nodoc
class _$DailyClosingResponseDtoCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? totalUnpaid = null,
    Object? totalsByPayment = null,
    ...
    return _then(_value.copyWith(
      ...
      totalPaid: null == totalPaid
          ...
          : totalPaid // ignore: cast_nullable_to_non_nullable
              as double,
      totalUnpaid: null == totalUnpaid
          ? _value.totalUnpaid
          : totalUnpaid // ignore: cast_nullable_to_non_nullable
              as double,
      totalsByPayment: null == totalsByPayment
          ? _value.totalsByPayment
          : totalsByPayment // ignore: cast_nullable_to_non_nullable
...
class __$$DailyClosingResponseDtoImplCopyWithImpl<$Res>
    extends _$DailyClosingResponseDtoCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$DailyClosingResponseDtoImpl(
      date: null == date
          ? _value.date
          : date // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$DailyClosingResponseDtoImpl implements _DailyClosingResponseDto {
  const _$DailyClosingResponseDtoImpl(
      ...
      @JsonKey(name: 'total_unpaid') this.totalUnpaid = 0.0,
      @JsonKey(
          name: 'totals_by_payment',
          fromJson: _parseDoubleMap,
          toJson: _identityMap)
      final Map<String, double> totalsByPayment = const <String, double>{},
      @JsonKey(name: 'summary_by_professional')
      final List<ProfessionalSummaryDto> summaryByProfessional = const []})
      : _items = items,
        _totalsByPayment = totalsByPayment,
  ...
  final Map<String, double> _totalsByPayment;
  @override
  @JsonKey(
      name: 'totals_by_payment',
      fromJson: _parseDoubleMap,
      toJson: _identityMap)
  Map<String, double> get totalsByPayment {
    if (_totalsByPayment is EqualUnmodifiableMapView) return _totalsByPayment;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_totalsByPayment);
  }
  ...
  @override
  String toString() {
    return 'DailyClosingResponseDto(date: $date, branchId: $branchId, branchName: $branchName, items: $items, grandTotal: $grandTotal, grandCommission: $grandCommission, totalPaid: $totalPaid, totalUnpaid: $totalUnpaid, totalsByPayment: $totalsByPayment, summaryByProfessional: $summaryByProfessional)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalUnpaid, totalUnpaid) ||
                other.totalUnpaid == totalUnpaid) &&
            const DeepCollectionEquality()
                .equals(other._totalsByPayment, _totalsByPayment) &&
            const DeepCollectionEquality()
                .equals(other._summaryByProfessional, _summaryByProfessional));
  }
  ...
  int get hashCode => Object.hash(
      ...
      totalPaid,
      totalUnpaid,
      const DeepCollectionEquality().hash(_totalsByPayment),
  ...
  _$$DailyClosingResponseDtoImplCopyWith<_$DailyClosingResponseDtoImpl>
      get copyWith => __$$DailyClosingResponseDtoImplCopyWithImpl<
          _$DailyClosingResponseDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DailyClosingResponseDtoImplToJson(
      this,
    );
  }
}
...
abstract class _DailyClosingResponseDto implements DailyClosingResponseDto {
  const factory _DailyClosingResponseDto(
          ...
          @JsonKey(name: 'total_unpaid') final double totalUnpaid,
          @JsonKey(
              name: 'totals_by_payment',
              fromJson: _parseDoubleMap,
              toJson: _identityMap)
